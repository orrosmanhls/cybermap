...
export default function Navbar() {
  ...
  useEffect(() => {
    M.Modal.init(navbarRef.current.querySelectorAll('.modal'));
    M.Sidenav.init(navbarRef.current.querySelectorAll('.sidenav'));
  }, []);
  ...
  return (
    <div ref={navbarRef}>
      <ul id="sidenav" className="sidenav">
        <li>
          <a className="modal-trigger" href="#about">About</a>
        </li>
        <li>
          <a className="modal-trigger" href="#addcompany">Add a company</a>
        </li>
        {/* <li><Link to="/careers">Careers</Link></li> */}
        <li>
          <a target="_blank" href="https://www.ylventures.com" rel="noopener noreferrer">ylventures.com</a>
        </li>
      </ul>
        ...
        <div className="container">
          <div className="nav-wrapper fixed-navbar padding-top-bottom">
            ...
            <ul className="right hide-on-med-and-down">
              ...
              {/* <li><Link to="/careers">Careers</Link></li> */}
              <li>
                <a className="no-hover cursor-default opacity-04">Analytics (soon)</a>
              </li>
              <li>
                <a
                  target="_blank"
                  href="https://www.ylventures.com"
      ...
      <div id="about" className="modal outline-0 modal-with-x">
        <div className="modal-closing-btn modal-close cursor-pointer">
          <i className="material-icons modal-icon">close</i>
        </div>
...
We made this live map to help our industry grow. If you have any questions, comments, or ideas on how to improve this map, we would love to hear them! We invite you to get in touch with us at `}
            <a href="mailto:dana@ylventures.com">dana@ylventures.com</a>
            <br />
            <br />
...
`}
      ...
      <div id="addcompany" className="modal outline-0">
        ...
        <div className="modal-content center">
          ...
          <p className="black-text nav-modal-p pre-wrap">
            {`                        
Want to appear on the map? Please send an email with your company’s name, website and logo (png or svg) to`}{" "}
            <a href="mailto:dana@ylventures.com"> dana@ylventures.com </a>
          </p>
        </div>
      </div>
